...
An animation of an HOURGLASS with falling sand. Press Command-C to stop.
...
try:
    ...
    print('This program requires bext module, which you')
    print('can install by following the instructions at')
    print('https://pypi.org/project/Bext')
    sys.exit()

# Setup the constants:
PAUSE_LENGTH = 0.3  # (!) Try changing to 0.0 or 1.0.
...
for i in range(18, 37):
    ...
    HOURGLASS.add((i, 23))  # Add walls for the bottom cap of the HOURGLASS.
for i in range(1, 5):
...
for i in range(8):
    HOURGLASS.add((19 + i, 5 + i))  # Add walls for the top left slanted wall.
...
def hourglass_simulation(all_sand):
    ...
    while True:  # Keep looping until sand has run out
        random.shuffle(all_sand)  # Random order of sand simulation
        ...
        for i, sand in enumerate(all_sand):
            ...
            if can_fall_down:
                ...
                # Set the sand in its new position down on space:
                ...
                # the left or right instead of just on space:
                if random.random() * 100 < WIDE_FALL_CHANCE:
                    ...
                    can_fall_two_left = (can_fall_left and no_sand_below_two_left and no_wall_below_two_left and
                    ...
                    can_fall_two_right = (can_fall_right and no_sand_below_two_right and no_wall_below_two_right and
